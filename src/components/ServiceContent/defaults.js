/**
 * ServiceContent default HTML by service slug.
 * Used when no CMS data is available for the service page content.
 */
export const ServiceContentDefaults = {
  resuscitation: `
    ...
    <p style="color: var(--blue-l)"><b>The service includes the activities of:</b></p>
    <ul>
      <li>CT scan without injection</li>
      <li>CT scan with injection</li>
      <li>Cardiac Scanner</li>
      <li>CoroScanner</li>
      <li>Perfusion Scanner (Body and Brain)</li>
      <li>Cardiac Scanner</li>
      <li>Digital Radio</li>
      <li>Ultrasound / Mammography</li>
      <li>3D scanner</li>
      <li>3D Radio</li>
    </ul>
  `,
