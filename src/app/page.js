...
const HeroDefaults = {
  title: "Cutting edge medicine in the heart of Africa",
  formTitle: "Book an Appointment",
  image: { src: "/images/hero-image.png", alt: "rapha-polyclinique" },
};
...
const TeamDefaults = {
  subtitle: "Our Medical Teams",
  title: "Excellence in Every Discipline",
  content: "Our hospital brings together leading experts across medicine, surgery, and diagnostics. With advanced training and a shared mission to raise healthcare standards in Africa, our teams set new benchmarks for patient care.",
  gallery: {
    left: [
